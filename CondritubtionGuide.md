...
- [Vue 3](https://github.com/vuejs/vue-next) & [Vite(dev server)](https://vitejs.dev)(A build command bundles codeRollup, pre-configured to outputoptimized assets for production)
